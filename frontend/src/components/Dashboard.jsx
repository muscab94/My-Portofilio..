...
function Dashboard({ children }) {
  ...
  return (
    <div className="flex  ">
      {/* Sidebar */}
      <div
        className={`fixed top-0 left-0 w-[294px] h-screen z-10  bg-gray-200 shadow-lg flex flex-col items-center py-10 
      ...
      <div className="flex-1 min-h-screen  overflow-y-auto py-20 md:ml-[250px]">
  {children}
</div>
